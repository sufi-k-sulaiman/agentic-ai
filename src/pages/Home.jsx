    ...
    return (
        <>
            ...
            <div className="p-4 md:p-8">
                ...
                <p className="mb-6 md:mb-8 text-gray-600">Agentic Ai from the 1C Platform introduces a new generation of autonomous Ai agents engineered to operate with minimal human oversight. Instead of relying on predefined scripts, these agents apply cognitive reasoning to interpret context, detect patterns, and make informed decisions in real time. Their architecture is optimized for speed and scale, allowing them to process tasks in under 100 milliseconds and execute millions of micro‑actions per day. This combination of rapid computation and contextual intelligence positions the system as a powerful engine for high throughput automation.
</p>
