...
import { Globe, Sparkles, BarChart3, Gamepad2, Settings, Radio, Brain, GraduationCap, ListTodo, StickyNote, Lightbulb, ScrollText, Newspaper, Shield, Smartphone, FileText } from 'lucide-react';
...
export const menuItems = [
    ...
    { label: 'Text', icon: FileText, href: createPageUrl('Text') },
