...
export default function SpaceBattleGame({ onExit }) {
    ...
    const LEVEL_QUESTIONS = {
        1: [
            { question: "What is agentic AI's primary capability?", options: ["Making autonomous decisions", "Only executing pre-programmed tasks", "Translating languages", "Creating art"], correctAnswer: 0, explanation: "Agentic AI is designed to make decisions and take actions independently based on its programming and goals.", tip: "Think about AI systems that learn and adapt over time." },
            { question: "Which data types can machine learning models process?", options: ["Only numerical data", "Only text data", "Text, images, audio, and video", "Only structured databases"], correctAnswer: 2, explanation: "Machine learning can process various data types including text, images, audio, and video through appropriate preprocessing.", tip: "Consider how AI handles images and text in everyday applications." },
            { question: "What is the most widely used programming language for AI development?", options: ["JavaScript", "Python", "Java", "C++"], correctAnswer: 1, explanation: "Python is the dominant language in AI due to its extensive libraries like TensorFlow, PyTorch, and scikit-learn.", tip: "Think about popular AI frameworks and their language support." },
            { question: "Which learning method can train neural networks without labeled data?", options: ["Supervised learning only", "Unsupervised learning", "Neither approach works", "Only manual training"], correctAnswer: 1, explanation: "Unsupervised learning and self-supervised learning methods can train neural networks without labeled data.", tip: "Consider different types of machine learning approaches." },
            { question: "What field inspired reinforcement learning?", options: ["Quantum physics", "Behavioral psychology", "Biology", "Astronomy"], correctAnswer: 1, explanation: "Reinforcement learning is based on concepts from behavioral psychology, particularly reward-based learning.", tip: "Think about how animals and humans learn through rewards and punishments." }
        ],
        2: [
            { question: "What is quantum computing's advantage?", options: ["Solves all problems faster", "Excels at specific problems only", "Uses less energy", "Costs less than classical computers"], correctAnswer: 1, explanation: "Quantum computers excel at specific problems but aren't universally faster for all computational tasks.", tip: "Consider the strengths and limitations of different computing paradigms." },
            { question: "Can blockchain function without a distributed network?", options: ["Yes, in centralized mode", "No, it requires distribution", "Only for cryptocurrencies", "Yes, on a single server"], correctAnswer: 1, explanation: "Blockchain's core value comes from decentralization and consensus across multiple nodes in a network.", tip: "Think about what makes blockchain secure and trustworthy." },
            { question: "What is edge computing designed to do?", options: ["Increase cloud storage", "Reduce latency by local processing", "Replace all servers", "Only work offline"], correctAnswer: 1, explanation: "Edge computing processes data near where it's generated, reducing the need to send data to distant cloud servers.", tip: "Consider IoT devices and real-time processing needs." },
            { question: "What does Explainable AI (XAI) provide?", options: ["Faster processing", "Transparency into AI decisions", "Lower costs", "Automatic debugging"], correctAnswer: 1, explanation: "Explainable AI (XAI) techniques can provide transparency into many AI model decisions.", tip: "Think about the growing field of interpretable machine learning." },
            { question: "What does 5G technology offer beyond faster speeds?", options: ["Only faster downloads", "Low latency and high device density", "Cheaper data plans", "Longer battery life"], correctAnswer: 1, explanation: "5G offers low latency, high device density, and network slicing in addition to faster speeds.", tip: "Consider the broader infrastructure improvements in 5G networks." }
        ],
        3: [
            { question: "Where was CRISPR-Cas9 discovered?", options: ["In bacteria", "In human cells", "In plants", "In laboratories"], correctAnswer: 0, explanation: "CRISPR-Cas9 was adapted from a natural defense mechanism found in bacteria against viruses.", tip: "Think about how nature inspired this revolutionary technology." },
            { question: "Can renewable energy provide 100% of global needs today?", options: ["Yes, easily", "No, due to storage and infrastructure challenges", "Only in sunny countries", "Only for electricity"], correctAnswer: 1, explanation: "While growing rapidly, renewable energy faces storage, distribution, and intermittency challenges for complete global coverage.", tip: "Consider current infrastructure and technology limitations." },
            { question: "How does nuclear fusion differ from fission?", options: ["They're the same process", "Fusion combines nuclei, fission splits them", "Fusion is less powerful", "Fission is cleaner"], correctAnswer: 1, explanation: "Fusion combines light nuclei to release energy, while fission splits heavy nuclei. Fusion is cleaner but harder to achieve.", tip: "Think about how the sun generates energy versus nuclear power plants." },
            { question: "Are all biodegradable plastics environmentally friendly?", options: ["Yes, all decompose naturally", "No, some need industrial conditions", "Only in water", "They never decompose"], correctAnswer: 1, explanation: "Some biodegradable plastics require specific industrial conditions to break down and may not decompose in natural environments.", tip: "Consider the conditions needed for decomposition." },
            { question: "What does photosynthesis convert?", options: ["Water to oxygen", "Light energy to chemical energy", "Sugar to carbon dioxide", "Soil to nutrients"], correctAnswer: 1, explanation: "Plants use photosynthesis to convert sunlight, water, and CO2 into glucose and oxygen.", tip: "Think about how plants create their own food." }
        ],
        4: [
            { question: "How is market capitalization calculated?", options: ["Stock price × outstanding shares", "Total revenue ÷ employees", "Assets - liabilities", "Daily trading volume"], correctAnswer: 0, explanation: "Market cap = share price × number of outstanding shares, representing the company's total market value.", tip: "Think about how company size is measured in the stock market." },
            { question: "Can cryptocurrency transactions be reversed?", options: ["Yes, within 24 hours", "No, they're irreversible", "Only with permission", "Yes, like credit cards"], correctAnswer: 1, explanation: "Most cryptocurrency transactions are irreversible once confirmed on the blockchain.", tip: "Consider the decentralized nature of blockchain technology." },
            { question: "How is compound interest calculated?", options: ["Only on initial principal", "On principal plus accumulated interest", "Only on withdrawals", "Annually only"], correctAnswer: 1, explanation: "Compound interest is calculated on the principal plus accumulated interest from previous periods.", tip: "Think about how your savings grow exponentially over time." },
            { question: "Do index funds typically have higher fees than actively managed funds?", options: ["Yes, much higher", "No, they have lower fees", "About the same", "Only in certain markets"], correctAnswer: 1, explanation: "Index funds usually have much lower fees because they passively track market indices rather than actively picking stocks.", tip: "Consider the effort and cost difference between passive and active management." },
            { question: "What is diversification in investing?", options: ["Buying only one stock", "Spreading investments to reduce risk", "Timing the market", "Day trading"], correctAnswer: 1, explanation: "Diversification spreads investments across different assets to minimize the impact of any single investment's poor performance.", tip: "Think about the saying 'don't put all your eggs in one basket.'" }
        ],
        5: [
            { question: "What is the leading cause of death globally?", options: ["Cancer", "Cardiovascular disease", "Accidents", "Infectious diseases"], correctAnswer: 1, explanation: "Heart disease and stroke are the world's leading causes of death, responsible for millions of deaths annually.", tip: "Consider major health challenges in both developed and developing countries." },
            { question: "Can antibiotics treat viral infections?", options: ["Yes, all infections", "No, only bacterial infections", "Only respiratory viruses", "Yes, with high doses"], correctAnswer: 1, explanation: "Antibiotics only work against bacterial infections, not viral infections like the common cold or flu.", tip: "Think about why doctors don't prescribe antibiotics for colds." },
            { question: "When is the human brain fully developed?", options: ["At age 18", "At age 21", "Around age 25", "At age 30"], correctAnswer: 2, explanation: "The prefrontal cortex, responsible for decision-making and impulse control, continues developing until around age 25.", tip: "Consider when people are considered fully mature neurologically." },
            { question: "What does regular exercise improve?", options: ["Only physical health", "Only mental health", "Both physical and mental health", "Neither significantly"], correctAnswer: 2, explanation: "Exercise releases endorphins, reduces stress hormones, and has been shown to alleviate symptoms of depression and anxiety.", tip: "Think about the mind-body connection in wellness." },
            { question: "Is BMI a perfect measure of individual health?", options: ["Yes, it's completely accurate", "No, it has limitations", "Only for athletes", "Only for children"], correctAnswer: 1, explanation: "BMI doesn't account for muscle mass, bone density, or body composition, and can be misleading for athletes and certain populations.", tip: "Consider the limitations of using just height and weight for health assessment." }
        ],
        6: [
            { question: "What primarily drives current climate change?", options: ["Natural cycles only", "Human activities", "Solar radiation", "Volcanic activity"], correctAnswer: 1, explanation: "Scientific consensus shows that human greenhouse gas emissions are the dominant cause of current global warming.", tip: "Think about industrial activities and their atmospheric impact since the 1800s." },
            { question: "Can AI fully replace human creativity?", options: ["Yes, completely", "No, AI lacks consciousness and cultural understanding", "Only in music", "Only in visual arts"], correctAnswer: 1, explanation: "While AI can assist and augment creativity, human creativity involves consciousness, emotions, and cultural understanding that AI lacks.", tip: "Consider the unique aspects of human imagination and cultural context." },
            { question: "Why is cybersecurity important in modern society?", options: ["It's not that important", "Only for governments", "Critical for digital infrastructure and data", "Only for banks"], correctAnswer: 2, explanation: "With increasing digitalization of critical infrastructure, personal data, and services, cybersecurity is crucial for modern society.", tip: "Think about how much of our lives depends on digital systems today." },
            { question: "Does social media directly cause depression in all users?", options: ["Yes, in everyone", "No, the relationship is complex", "Only in teenagers", "Only with overuse"], correctAnswer: 1, explanation: "While excessive social media use is linked to mental health issues, the relationship is complex and varies by individual and usage patterns.", tip: "Consider the nuanced relationship between technology use and mental health." },
            { question: "What is space exploration about?", options: ["Only scientific discovery", "Discovery, innovation, and cooperation", "Only military purposes", "Only tourism"], correctAnswer: 1, explanation: "Space exploration also drives technological innovation, economic opportunities, international cooperation, and inspires future generations.", tip: "Think about the broader impacts of space programs on society." }
        ]
    };
